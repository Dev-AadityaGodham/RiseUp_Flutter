...
class hindi_page extends StatefulWidget {
  const hindi_page({Key? key}) : super(key: key);

  @override
  State<hindi_page> createState() => _hindi_pageState();
}

class _hindi_pageState extends State<hindi_page> {
  List hindi_page = [];
  ...
  _initData() async {
    await DefaultAssetBundle.of(context)
        .loadString("assets/Hindi.json")
        .then(((value) {
      setState(() {
        hindi_page = json.decode(value);
      });
    }));
  }
          ...
          children: [
            ...
            IconButton(
              ...
              onPressed: () async {
                ...
                if (index >= 0 && hindi_page.length >= 0) {
  ...
  _initializeVideo(int index) async {
    final controller = VideoPlayerController.networkUrl(
        Uri.parse(hindi_page[index]["videoUrl"]));
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: AssetImage(hindi_page[index]["thumbnail"]),
                          fit: BoxFit.cover,
                        )),
                  ),
                  SizedBox(width: 16),
