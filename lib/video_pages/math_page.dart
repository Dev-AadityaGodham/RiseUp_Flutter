...
class Math_page extends StatefulWidget {
  const Math_page({Key? key}) : super(key: key);

  @override
  State<Math_page> createState() => _Math_pageState();
}
...
class _Math_pageState extends State<Math_page> {
  ...
  _initData() async {
    await DefaultAssetBundle.of(context)
        .loadString("assets/Math.json")
        .then(((value) {
      setState(() {
        Math_page = json.decode(value);
      });
    }));
  }
  ...
  _initializeVideo(int index) async {
    final controller = VideoPlayerController.networkUrl(
        Uri.parse(Math_page[index]["videoUrl"]));
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: AssetImage(Math_page[index]["thumbnail"]),
                          fit: BoxFit.cover,
                        )),
                  ),
                  SizedBox(width: 16),
