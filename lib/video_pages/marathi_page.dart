...
class marathi_page extends StatefulWidget {
  const marathi_page({Key? key}) : super(key: key);

  @override
  State<marathi_page> createState() => _marathi_pageState();
}

class _marathi_pageState extends State<marathi_page> {
  List marathi_page = [];
  ...
  _initData() async {
    await DefaultAssetBundle.of(context)
        .loadString("assets/Marathi.json")
        .then(((value) {
      setState(() {
        marathi_page = json.decode(value);
      });
    }));
  }
          ...
          children: [
            ...
            IconButton(
              ...
              onPressed: () async {
                ...
                if (index >= 0 && marathi_page.length >= 0) {
            ...
            IconButton(
              ...
              onPressed: () async {
                // Action to be performed when the button is pressed
                final index = _isPlayingIndex + 1;
                if (index < marathi_page.length - 1) {
                  _initializeVideo(index);
                } else {
  ...
  _initializeVideo(int index) async {
    final controller = VideoPlayerController.networkUrl(
        Uri.parse(marathi_page[index]["videoUrl"]));
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: AssetImage(marathi_page[index]["thumbnail"]),
                          fit: BoxFit.cover,
                        )),
                  ),
                  SizedBox(width: 16),
